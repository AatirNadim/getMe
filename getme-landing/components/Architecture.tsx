...
export default function Architecture() {
  ...
  const titleContent = (
    <>
      ...
      <h2 className="text-[1.8rem] min-[480px]:text-[clamp(2rem,3.5vw,2.8rem)] font-extrabold tracking-[-0.03em] text-blue-950 dark:text-white mb-4 leading-[1.1]">
        Engineered for
        <br />
  ...
  return (
    <ParallaxSection id="architecture" className="" title={titleContent}>
      <div
        ref={containerRef}
        className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-15 items-center w-full"
      >
        {/* Architecture Diagram Box */}
        <div className="arch-diagram opacity-0 bg-white/90 dark:bg-blue-850/90 border border-(--border-medium) rounded-xl p-8 relative shadow-glow-md backdrop-blur-md">
        ...
        <div className="arch-features-container">
          ...
          <div className="arch-feature opacity-0 flex gap-4 py-5 border-b border-(--border-subtle) last:border-b-0">
            ...
            <div>
              ...
              <div className="text-[0.83rem] text-(--text-secondary) leading-[1.6]">
                Blazing fast local Inter-Process Communication bypassing the TCP
                stack. Extremely low-overhead routing for SDKs and the CLI.
              </div>
            </div>
          </div>
        </div>
